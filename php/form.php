<?php
$recipient = 'arnaldpedros@gmail.com'; // Enter the recipient's email address here.
$subject   = 'New contact sent from spanishguitar.cat.'; // Enter the subject of the email here.
